...
class EasySlider extends StatefulWidget {
  final double value;
  final double min;
  final double max;
  final double? width;
  final EasySliderThumb? thumb;
  ...
  @override
  State<EasySlider> createState() => _EasySliderState();
}

class _EasySliderState extends State<EasySlider> {
  late double _value;
  late EasySliderThumb _thumb;

  @override
  void initState() {
    super.initState();
    _value = widget.value;
    _thumb = widget.thumb ?? EasySliderThumb.basic();
  }
