...
abstract class Debug {
  ...
  static String _formatJsonToReadableLog(String json) {
    try {
  ...
  static void severe(Object message, {bool sendToDiscord = false}) {
    logger.severe(message.toString());
    if (sendToDiscord) {
      discord.sendMessage(message.toString());
    }
  }
  ...
  static void ensureInitialized({Level level = Level.ALL}) {
    Logger.root.level = level; // 로그 레벨 설정
