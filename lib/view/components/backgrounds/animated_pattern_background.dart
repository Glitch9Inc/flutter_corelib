...
import 'package:flutter_corelib/view/components/painters/pattern_painter.dart';
import 'package:flutter_corelib/view/ui_framework/models_enum/widget_direction.dart';
import 'package:flutter_corelib/view/ui_framework/view_utils/view_utils.dart';
...
class _AnimatedPatternBackgroundState extends State<AnimatedPatternBackground> with SingleTickerProviderStateMixin {
  ...
  Future<List<ui.Image>> _loadImages() async {
    final images = await Future.wait(widget.iconImagePaths.map((path) => ViewUtils.loadImage(path)).toList());
    return images;
  }
