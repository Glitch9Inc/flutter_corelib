/// A class that can hold either a string or an object of type T.
/// This structure is often used in LLM APIs.
class StringOr<T> {
  ...
  @override
  int get hashCode => stringValue.hashCode ^ objectValue.hashCode;
}
